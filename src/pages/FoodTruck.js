        ...
        <div className="FoodTruck">
            ...
            <div className={`transition duration-500 ${isOpen ? 'opacity-0' : 'opacity-100'}`}>
                ...
                <div className="flex flex-col justify-center items-center pb-10">
                    <div className="text-center text-base NanumSquareEB mb-3">꺼리분식</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>순대 - 5,000원</div>
                        <div>떡볶이 - 5,000원</div>
                        <div>오뎅 - 3,000원</div>
                    </div>
                    <div className="text-center text-base NanumSquareEB my-3">꼬지천국</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>타코야끼(8pcs)</div>
                        <div>오리지날 - 5,000원</div>
                        <div>바베큐.치즈맛.매운맛 - 6,000원</div>
                    </div>
                    <div className="text-center text-base NanumSquareEB my-3">파파</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>닭꼬치 - 5,000원</div>
                        <div>염통꼬치 - 2개 5,000원</div>
                    </div>
                    <div className="text-center text-base NanumSquareEB my-3">모니카</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>스테이크 - 10,000원</div>
                        <div>스테이크 덮밥 - 10,000원</div>
                    </div>
                    <div className="text-center text-base NanumSquareEB my-3">온</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>닭강정</div>
                    ...
                    <div className="text-center text-base NanumSquareEB my-3">비바</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>탕후루</div>
                    ...
                    <div className="text-center text-base NanumSquareEB my-3">미소</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                    ...
                    <div className="text-center text-base NanumSquareEB my-3">원츄추러스</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>츄러스 1개 - 4,000원</div>
                        <div>츄러스 3개 - 10,000원</div>
                    </div>
                    <div className="text-center text-base NanumSquareEB my-3">러브디아</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
                        <div>소고기불초밥(8pcs) - 10,000원</div>
                    </div>
                    <div className="text-center text-base NanumSquareEB my-3">디아이</div>
                    <div className="text-base text-black NanumSquareEB flex flex-col foodmenu-background rounded-lg bg-gray-200 w-80 py-3 px-4">
